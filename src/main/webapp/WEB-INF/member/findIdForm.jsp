            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="findId.mem" method="post">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                            	 <a href="auth-reset-password.html" class="text-right f-w-600">아이디 찾기</a>&nbsp;|
                                    ...
                                    <div class="row m-t-30">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            onclick="javascipt:location.href='register.mem'">회원가입</button>
                                        </div>
                                    </div>
